...
<div class="form-wrapper">
    <v-group :title="_('CheckBox')" vname="v-checkbox" :dataKey="checkbox"></v-group>
    <v-group :title="_('Select')" vname="v-select" :dataKey="select"></v-group>
    <v-group :title="_('Radio')" vname="v-radio" :dataKey="radio"></v-group>
    <v-group :title="_('Input')" vname="v-input" :dataKey="input"></v-group>
    <v-group :title="_('Input Area')" vname="v-input" :dataKey="input1"></v-group>
    <v-group :title="_('Slide Bar')" vname="v-slider" :dataKey="slider"></v-group>
    <v-group :title="_('Switch')" vname="v-switch" :dataKey="switcht"></v-group>
    <v-text :title="_('Title')" content="内容"></v-text>
