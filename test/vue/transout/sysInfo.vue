        ...
        <div class="sys-wifi">
          <div class="sys-wifi-row">
            ...
            <div class="sys-wifi-mess">
              <label class="margin-60">{{_('2.4G: %s', [wan_info['2Gssid']])}}</label>
              <label>{{_('5G: %s', [wan_info['5Gssid']])}}</label>
            </div>
          </div>
          <div class="sys-wifi-row">
            <div class="sys-wifi-title border-b">{{_('Wan Ip Address')}}</div>
...
export default {
  ...
  methods: {
    ...
    wanDetail() {
      this[types.SET_SUB_DIRECT](_("Net Mess"));
      this.is_wan_detail = true;
    },
    nodeDetail(sn) {
      this[types.SET_CUR_NODE](sn);
      this[types.SET_SUB_DIRECT](_("Node Mess"));
